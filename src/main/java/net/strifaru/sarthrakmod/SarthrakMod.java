package net.strifaru.sarthrakmod;
...
@Mod(SarthrakMod.MOD_ID)
public class SarthrakMod
{
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "sarthrakmod";
    // Directly reference a slf4j logger
    public static final Logger LOGGER = LogUtils.getLogger();

    public SarthrakMod(FMLJavaModLoadingContext context) {
